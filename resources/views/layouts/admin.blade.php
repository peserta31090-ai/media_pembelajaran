...
<head>
    ...
    <title>@yield('title', 'Admin') - Media Pembelajaran SMKN 1 Sintuk Toboh Gadang</title>
    ...
    <style>
        ...
        .sidebar-nav .nav-link.active {
            color: white;
            background: linear-gradient(90deg, #2563eb 0%, rgba(37,99,235,0.3) 80%, transparent 100%);
            font-weight: 500;
        }
    ...
    <div class="wrapper">
        <nav class="sidebar" id="sidebar">
            ...
            <div class="sidebar-nav">
                ...
                <div class="nav-header">Konten</div>
        ...
        <div class="main-content" id="mainContent">
            <nav class="navbar-top d-flex justify-content-between align-items-center">
                <div>
                    <button class="btn btn-sm btn-outline-secondary me-2 d-md-none" id="sidebarToggle" onclick="toggleSidebar()">
                        <i class="bi bi-list"></i>
                    </button>
                    <button class="btn btn-sm btn-outline-secondary d-none d-md-inline-block" id="sidebarCollapse" onclick="toggleCollapse()">
