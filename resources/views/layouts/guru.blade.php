...
<head>
    ...
    <title>@yield('title', 'Guru') - Media Pembelajaran SMKN 1 Sintuk Toboh Gadang</title>
    ...
    <style>
        ...
        .sidebar-nav .nav-item { margin: 0.125rem 0; }
    ...
    <div class="wrapper">
        <nav class="sidebar" id="sidebar">
            ...
            <div class="sidebar-nav">
                <div class="nav-header">Menu Guru</div>
                ...
                <div class="nav-item">
                    <a href="{{ route('guru.video.index') }}" class="nav-link {{ request()->routeIs('guru.video.*') ? 'active' : '' }}">
                ...
                <div class="nav-item">
                    <a href="{{ route('guru.kuis.index') }}" class="nav-link {{ request()->routeIs('guru.kuis.*') ? 'active' : '' }}">
